...
[[ -n "${GEV_AI_PROVIDER:-}" ]] && KEY_SETUP_EXTERNAL_KEYS+=(GEV_AI_PROVIDER)
[[ -n "${LOCAL_AI_PROFILE:-}" ]] && KEY_SETUP_EXTERNAL_KEYS+=(LOCAL_AI_PROFILE)
[[ -n "${LOCAL_AI_LANGUAGE:-}" ]] && KEY_SETUP_EXTERNAL_KEYS+=(LOCAL_AI_LANGUAGE)
[[ -n "${LOCAL_AI_MCP_URL:-}" ]] && KEY_SETUP_EXTERNAL_KEYS+=(LOCAL_AI_MCP_URL)
[[ -n "${LOCAL_AI_MCP_TOOL:-}" ]] && KEY_SETUP_EXTERNAL_KEYS+=(LOCAL_AI_MCP_TOOL)
